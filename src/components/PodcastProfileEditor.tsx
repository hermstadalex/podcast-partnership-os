...
export function PodcastProfileEditor({ showId, onClose }: PodcastProfileEditorProps) {
  ...
  const handleSave = async () => {
    if (!showId) return;
    // In our actual app, this updates Captivate and our synced Supabase database record
    const promise = updateShowMetadata(showId, { title, description, author, image });
