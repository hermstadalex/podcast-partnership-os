      ...
      <header className="flex h-16 shrink-0 items-center justify-between border-b border-zinc-800 px-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-semibold tracking-tight text-zinc-100 flex items-center gap-2">
            EpisodeArtBot
            <span className="px-2 py-0.5 rounded-full bg-zinc-800 text-[10px] text-zinc-400 font-mono tracking-widest outline border border-zinc-700">OIL-PHASE-ARCHITECTURE</span>
          </h1>
        </div>
      </header>
