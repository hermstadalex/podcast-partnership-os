...
import { ZernioPublishWizard } from '@/components/taskbots/ZernioPublishWizard';
import { Share2 } from 'lucide-react';

export const metadata = {
  title: 'Zernio Publish Wizard | Taskbots | Podcast Partnership OS',
};

export default async function ZernioPublishPage() {
        ...
        <div className="mx-auto max-w-6xl space-y-8">
          ...
          <div className="mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight mb-3 flex items-center gap-2 sm:gap-3">
              <Share2 className="h-6 w-6 sm:h-8 sm:w-8 text-blue-400 shrink-0" />
              Publish to Social Media
            </h2>
            <p className="text-zinc-400 max-w-3xl text-lg">
              Upload an asset, generate viral AI captions, and dispatch it to YouTube, TikTok, and Instagram in one click using Zernio.
            </p>
          </div>

          <ZernioPublishWizard shows={formattedShows} />
